        ...
        <div className="grid md:grid-cols-12 grid-cols-1 sm:grid-cols-12">
          ...
          <div className="md:col-span-4 sm:col-span-6 col-span-12 sm:border-r border-b border-solid border-dark_border flex items-center sm:border-b-0 sm:min-h-25 py-10 shrink-0">
            <div className="sm:content-normal sm:text-start text-center content-center sm:w-auto w-full">
              ...
              <a
                href="#contact"
                className="px-9 py-3 rounded-lg bg-primary text-white hover:bg-blue-700 hover:shadow-none transition-colors"
              >
                นัดปรึกษาฟรี
              </a>
            </div>
          ...
          <div className="md:col-span-4 sm:col-span-6 col-span-12 sm:flex items-center sm:min-h-25 py-10 justify-center shrink-0 md:border-r border-b sm:border-b-0 border-solid border-dark_border">
            <div className="flex flex-col md:items-start items-center">
              ...
              <div className="pb-5 sm:block flex gap-2">
                <p className="text-base font-bold text-white">โทรศัพท์</p>
                <a
              ...
              <div className="sm:block flex items-center gap-3">
                <p className="text-base font-bold text-white">อีเมล</p>
                <a
                  href="mailto:info@whocare.co.th"
                  className="text-2xl text-white/50 hover:text-white transition-colors"
                >
                  info@whocare.co.th
                </a>
          ...
          <div className="md:col-span-4 col-span-12 border-t md:border-none border-solid border-dark_border sm:flex items-center justify-end md:min-h-25 py-10 shrink-0">
            <div className="md:w-3/4 w-full sm:text-start text-center">
              ...
              <p className="text-base pb-7 text-white/50">
                ติดตามข่าวสาร โปรโมชั่นพิเศษ และเคล็ดลับความงาม
              </p>
              <form className="flex rounded-lg sm:w-full w-3/4 sm:mx-0 mx-auto">
                <input
                  type="email"
                  placeholder="Email*"
                  className="p-4 text-base border-transparent rounded-s-lg rounded-e-none outline-0 focus:border-primary dark:focus:border-primary w-[calc(100%_-_137px)] flex bg-white dark:bg-midnight_text dark:text-white dark:border-solid dark:border dark:border-border"
                />
                <button
                  type="submit"
                  className="p-[0.625rem] text-base font-medium bg-primary text-white border-none cursor-pointer rounded-e-lg outline-0 text-center w-[8.5625rem] hover:bg-blue-700 hover:shadow-none transition-colors"
                >
                  สมัครรับข่าว
                </button>
              </form>
